...
\label{sec:hyperparameter_learning}
	...
	% , is general for any conditional embedding with discrete target space given any family of positive definite kernels $k_{\theta}$ over $\theta \in \Theta$ and $\lambda \in \Lambda$
