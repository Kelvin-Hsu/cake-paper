...
\usepackage{etoolbox}
\patchcmd{\bibliography}{\chapter*}{\subsection*}{}{}
...
\begin{document}
	...
	\begin{abstract}
		...
		\keywords{Conditional Mean Embeddings, Kernel Mean Embeddings, Kernel Methods, Mean Embeddings, Hilbert Space Embeddings, Hyperparameter Learning, Rademacher Complexity}
		% % % Original:
